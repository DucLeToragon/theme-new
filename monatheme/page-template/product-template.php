...
?>
    <main class="main">
        ...
        $Mona_Load_Field->mona_product_slider_image_items(get_the_ID(), $args); ?>
                    ...
                    <div class="wrapper-container">
                        ...
                        <div class="box-danhmuc">
                            ...
                            <div class="wrapper-danhmuc">
                                <a href="<?php echo get_the_permalink(); ?>" class="item <?php echo (is_page(MONA_SAN_PHAM)) ? 'active' : '' ?> link-w-0">
                                    <?php echo __('ALL', 'monamedia'); ?>
                                </a>
                                <?php
                                $obz = get_queried_object_id();
                                if (!empty($categoryproduct)) {
                                    foreach ($categoryproduct as $key => $item) {
                                        if (is_tax() && $obz === $item->term_id) {
                        ...
                        <?php
                        $mota = get_field('mona_top_content');
                        if ($mota != '') {
                        ?>
                            <section class="mona-sec">
                                <div class="container">
                        ...
                        <div class="box-product-main">
                            ...
                            <?php mona_page_navi($queryproduct); ?>
                        </div>
                        <?php
                        $mota = get_field('mona_bot_content');
                        if ($mota != '') {
                        ?>
                            <section class="mona-sec">
                                <div class="container">
